Feature: Creator adds a Contributor
    ...
    Scenario Outline: Creator opens the Add Contributor Dialog
        ...
        Examples:
            ...
            | Artistic         | PerformingArts            | Dancer, Actor, Choreographer, Director, Scenograph, Costume designer, Producer, Artistic leader, Dramatist, Librettist, Dramaturge, Sound designer, Light designer, Other |
