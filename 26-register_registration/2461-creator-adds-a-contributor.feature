Feature: Creator adds a Contributor
    ...
    Scenario Outline: Creator opens the Add Contributor Dialog
        ...
        Examples:
            ...
            | Artistic          | Architect                     | Architect, Landscape architect, Interior architect, Architectural planner, Other                                                                                            |
            | Artistic          | PerformingArts                | Dancer, Actor, Choreographer, Director, Scenographer, Costume designer, Producer, Artistic leader, Dramatist, Librettist, Dramaturge, Sound designer, Light designer, Other |
