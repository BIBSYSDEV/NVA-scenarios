Feature: Creator adds a Contributor
    ...
    Scenario Outline: Creator opens the Add Contributor Dialog
        ...
        Examples:
            ...
            | Media            | Programme management    | Contact person, Editor, Related person, Researcher, Rights holder, Supervisor, Other |
            | Media            | Programme participation | Contact person, Editor, Related person, Researcher, Rights holder, Supervisor, Other |
