Feature: Creator navigates to Contributors tab
  ...
  Scenario Outline: Creator see buttons to add Contributors
    ...
    Examples:
      ...
      | MediaContribution | MediaInterview                | Add Journalist, Add Interviewee, Add Contributor  |
      | MediaContribution | MediaBlogPost                 | Add Author, Add Contributor                       |
      | MediaContribution | MediaPodcast                  | Add ProgramHost, Add Participant, Add Contributor |
      | MediaContribution | MediaParticipationInRadioOrTv | Add ProgramHost, Add Participant, Add Contributor |
